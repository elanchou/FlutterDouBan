    ...
    return Row(
      ...
      children: <Widget>[
        _TextImgWidget(
          ...
          tabCallBack: () {
            print('点击找电影');
            AppRouter.push(context, AppRouter.searchPage, '找电影');
          },
        ),
        _TextImgWidget(
          '豆瓣榜单',
          ...
          tabCallBack: () {
            print('点击豆瓣榜单');
            AppRouter.push(context, AppRouter.searchPage, '豆瓣榜单');
          },
        ),
        _TextImgWidget(
          '豆瓣猜',
          ...
          tabCallBack: () {
            AppRouter.push(context, AppRouter.searchPage, '豆瓣猜');
          },
        ),
        _TextImgWidget(
          '豆瓣片单',
          ...
          tabCallBack: () {
            AppRouter.push(context, AppRouter.searchPage, '豆瓣片单');
          },
        )
      ],
    );
